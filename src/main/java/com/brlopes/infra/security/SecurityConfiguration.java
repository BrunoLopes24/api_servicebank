...
@Configuration
@EnableWebSecurity // Habilita a configuração WebSecurity
public class SecurityConfiguration {
    ...
    public SecurityFilterChain SecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        .requestMatchers(HttpMethod.POST, "auth/register").permitAll() // In normal situation, this endpoint should be allowed only to ADMIN.
        ...
        .requestMatchers(HttpMethod.POST, "/transactions/").hasRole("CLIENT") // findAll()
